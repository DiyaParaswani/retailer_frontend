...
void main() {
  runApp(MaterialApp(home: auctiontoday(),));
}
class auctiontoday extends StatefulWidget {
  @override
  _auctiontodayState createState() => _auctiontodayState();
}

class _auctiontodayState extends State<auctiontoday> {
